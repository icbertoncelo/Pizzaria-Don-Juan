...
export const reducer = createReducer(INITIAL_STATE, {
  [Types.GET_TYPES_PRODUCTS_REQUEST]: state => state.merge({ loading: true, error: false }),
  [Types.GET_TYPES_PRODUCTS_SUCCESS]: (state, { data }) => state.merge({ data, loading: false, error: false }),
